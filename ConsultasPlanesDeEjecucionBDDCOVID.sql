...
--10. Determinar en que rango de edad: menor de edad, 19 a 40, 40 a 60 o mayor de 60 hay mas casos reportados que se hayan recuperado.
declare @var6 int, @var7 int, @var8 int, @var9 int;
...
select EDAD as 'en este rango de edad hay mas casos recuperados' from datoscovid  where 
case 'rango de edad' 
when @var6>@var7 and @var6>@var8 and @var6>@var9 then 'menores de edad'
when @var7>@var6 or @var7>@var8 or @var7>@var9 then 'edad entre 19 y 40 años'
when  @var8>@var6 and @var8>@var7 and @var8>@var9 then 'edad entre 40 y 60 años'
when  @var9>@var6 and @var9>@var7 and @var9>@var8  then 'mayores de 60'
end